        ...
        <Box sx={style}  >
          ...
          <div className='d-flex flex-row justify-content-between gap-2'>
            <div className='d-flex flex-column gap-2'>
              <h4 className='pb-1'>{login ? "Create Account" : "Sign In"}</h4>
              <div>
              ...
              <button className='btn btn-primary col-12 mt-3 mb-4 rounded-5'>{login ? "Create Account" : "Sign In"}</button>
            ...
            <div className='d-flex flex-column align-items-center'>
              <span onClick={() => setLogin(!login)}>{login ? "Already" : "Don't"} have an account? <span className='text-primary '>{login ? "Sign in":"Create New For free"}</span></span>
